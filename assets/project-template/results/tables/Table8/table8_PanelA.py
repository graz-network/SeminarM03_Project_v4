...
_LAUNCHER_SCRIPT_STEM = 'table8_PanelA'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'table8_PanelA.txt'
...
# 10. Save the table
# -----------------------------
table_final.to_string("Table8_PanelA.txt", index=False)