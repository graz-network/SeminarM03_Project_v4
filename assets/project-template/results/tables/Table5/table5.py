...
_LAUNCHER_SCRIPT_STEM = 'table5'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'table5.txt'
...
# -----------------------------
# 3. Keep RD sample only
# -----------------------------
base = df[df["rdd_sample"] == 1].copy()
...
# -----------------------------
# 5. Table 5 specifications
# -----------------------------
specs = [
    {"col": "(1)", "bw_type": "CCT",   "h": 18.41, "poly": "Linear"},
    {"col": "(2)", "bw_type": "CCT/2", "h": 9.20,  "poly": "Linear"},
    {"col": "(3)", "bw_type": "2CCT",  "h": 36.82, "poly": "Linear"},
    {"col": "(4)", "bw_type": "IK",    "h": 18.36, "poly": "Linear"},
    {"col": "(5)", "bw_type": "CCT",   "h": 21.69, "poly": "Quadratic"},
]
...
# 9. Save the table
# -----------------------------
table_final.to_string("Table5.txt", index=False)