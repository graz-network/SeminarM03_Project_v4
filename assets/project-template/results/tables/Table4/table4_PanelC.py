...
_LAUNCHER_SCRIPT_STEM = 'table4_PanelC'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'table4_PanelC.txt'
...
# -----------------------------
# 2. Variable setup for Table 4 Panel C
# -----------------------------
...
# -----------------------------
# 3. Keep RD sample, women only, and non-joint-party only
# -----------------------------
base = df[
    (df["rdd_sample"] == 1) &
    (df["female"] == 1) &
...
# -----------------------------
# 5. Table 4 Panel C specifications
# -----------------------------
specs = [
    {"col": "(1)", "bw_type": "CCT",   "h": 13.18, "poly": "Linear"},
    {"col": "(2)", "bw_type": "CCT/2", "h": 6.59,  "poly": "Linear"},
    {"col": "(3)", "bw_type": "2CCT",  "h": 26.36, "poly": "Linear"},
    {"col": "(4)", "bw_type": "IK",    "h": 17.43, "poly": "Linear"},
    {"col": "(5)", "bw_type": "CCT",   "h": 24.52, "poly": "Quadratic"},
]
...
# 9. Save the table
# -----------------------------
table_final.to_string("Table4_PanelC.txt", index=False)
