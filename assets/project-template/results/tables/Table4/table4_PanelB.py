...
_LAUNCHER_SCRIPT_STEM = 'table4_PanelB'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'table4_PanelB.txt'
...
# -----------------------------
# 2. Variable setup for Table 4 Panel B
# -----------------------------
...
# -----------------------------
# 3. Keep RD sample, women only, and joint-party only
# -----------------------------
base = df[
    (df["rdd_sample"] == 1) &
    (df["female"] == 1) &
...
# -----------------------------
# 5. Table 4 Panel B specifications
# -----------------------------
specs = [
    {"col": "(1)", "bw_type": "CCT",   "h": 17.49, "poly": "Linear"},
    {"col": "(2)", "bw_type": "CCT/2", "h": 8.74,  "poly": "Linear"},
    {"col": "(3)", "bw_type": "2CCT",  "h": 34.97, "poly": "Linear"},
    {"col": "(4)", "bw_type": "IK",    "h": 22.23, "poly": "Linear"},
    {"col": "(5)", "bw_type": "CCT",   "h": 25.14, "poly": "Quadratic"},
]
...
# 9. Save the table
# -----------------------------
table_final.to_string("Table4_PanelB.txt", index=False)