...
_LAUNCHER_SCRIPT_STEM = 'tableA8'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA8.txt'
...
# 1. Load the dataset
# -----------------------------
df = pd.read_stata("../../../data/raw/dataset_with_lagged_rank_improvments.dta")
...
# -----------------------------
specs = [
    {"bw_type": "CCT",   "h": 15.71, "poly": "Linear"},
    {"bw_type": "CCT/2", "h":  7.85, "poly": "Linear"},
    {"bw_type": "2CCT",  "h": 31.42, "poly": "Linear"},
    {"bw_type": "IK",    "h": 17.22, "poly": "Linear"},
    {"bw_type": "CCT",   "h": 17.73, "poly": "Quadratic"},
]
...
# -----------------------------
# 5. Build exact text-style output
# -----------------------------
line = "-" * 92
lines = []
