...
_LAUNCHER_SCRIPT_STEM = 'tableA10_PanelA'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA10_PanelA.txt'
...
# -----------------------------
specs = [
    {"col": "(1)", "bw_type": "CCT",   "h": 19.31, "poly": "Linear"},
    {"col": "(2)", "bw_type": "CCT/2", "h": 9.66,  "poly": "Linear"},
    {"col": "(3)", "bw_type": "2CCT",  "h": 38.63, "poly": "Linear"},
    {"col": "(4)", "bw_type": "IK",    "h": 17.35, "poly": "Linear"},
    {"col": "(5)", "bw_type": "CCT",   "h": 15.49, "poly": "Quadratic"},
]
...
# 7. Save the table
# -----------------------------
with open("TableA10_PanelA.txt", "w", encoding="utf-8") as f:
    f.write(line + "\n")
