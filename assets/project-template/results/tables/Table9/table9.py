...
_LAUNCHER_SCRIPT_STEM = 'table9'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'table9.txt'
...
# 1. Load the dataset
# -----------------------------
df = pd.read_stata("../../../data/raw/neighbor_regressions_dataset.dta")

# -----------------------------
# 2. Variable setup for Table 9
# -----------------------------
...
# -----------------------------
# 5. Table 9 specifications
# -----------------------------
specs = [
    {"col": "(1)", "bw_type": "CCT",   "h": 15.40, "poly": "Linear"},
    {"col": "(2)", "bw_type": "CCT/2", "h": 7.70,  "poly": "Linear"},
    {"col": "(3)", "bw_type": "2CCT",  "h": 30.81, "poly": "Linear"},
    {"col": "(4)", "bw_type": "IK",    "h": 15.57, "poly": "Linear"},
    {"col": "(5)", "bw_type": "CCT",   "h": 27.88, "poly": "Quadratic"},
]
...
# 9. Save the table
# -----------------------------
table_final.to_string("Table9.txt", index=False)