...
_LAUNCHER_SCRIPT_STEM = 'tableA13_PanelA'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA13_PanelA.txt'
...
# -----------------------------
specs = [
    {"depvar": "age",                "label": "(1)", "bw_type": "CCT", "h": 22.18},
    {"depvar": "non_university_phd", "label": "(2)", "bw_type": "CCT", "h": 18.39},
    {"depvar": "university",         "label": "(3)", "bw_type": "CCT", "h": 18.69},
    {"depvar": "phd",                "label": "(4)", "bw_type": "CCT", "h": 19.37},
]
...
# 7. Save the table
# -----------------------------
with open("TableA13_PanelA.txt", "w", encoding="utf-8") as f:
    f.write(table_text)