...
_LAUNCHER_SCRIPT_STEM = 'tableA13_PanelC'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA13_PanelC.txt'
...
# -----------------------------
specs = [
    {"depvar": "employed",          "label": "(1)", "bw_type": "CCT", "h": 18.92},
    {"depvar": "selfemployed",      "label": "(2)", "bw_type": "CCT", "h": 21.21},
    {"depvar": "student",           "label": "(3)", "bw_type": "CCT", "h": 15.35},
    {"depvar": "retired",           "label": "(4)", "bw_type": "CCT", "h": 20.60},
    {"depvar": "housewifehusband",  "label": "(5)", "bw_type": "CCT", "h": 21.50},
]
...
# 7. Save the table
# -----------------------------
with open("TableA13_PanelC.txt", "w", encoding="utf-8") as f:
    f.write(table_text)