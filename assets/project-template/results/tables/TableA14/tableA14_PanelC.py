...
_LAUNCHER_SCRIPT_STEM = 'tableA14_PanelC'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA14_PanelC.txt'
...
# -----------------------------
specs = [
    {"depvar": "employed",      "label": "(1)", "bw_type": "CCT", "h": 13.85},
    {"depvar": "selfemployed",  "label": "(2)", "bw_type": "CCT", "h": 17.65},
    {"depvar": "student",       "label": "(3)", "bw_type": "CCT", "h": 14.70},
    {"depvar": "retired",       "label": "(4)", "bw_type": "CCT", "h": 12.08},
]
...
lines.append(line)
lines.append(f"{'':<22}{'(1)':>14}{'(2)':>16}{'(3)':>16}{'(4)':>16}")
lines.append(line)
...
# 7. Save the table
# -----------------------------
with open("TableA14_PanelC.txt", "w", encoding="utf-8") as f:
    f.write(table_text)