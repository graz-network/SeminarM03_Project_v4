...
_LAUNCHER_SCRIPT_STEM = 'tableA14_PanelB'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA14_PanelB.txt'
...
# 2. Restrict sample
# -----------------------------
work = df[(df["rdd_sample"] == 1) & (df["female"] == 0)].copy()

# -----------------------------
# 3. Dependent variables and fixed bandwidths
# -----------------------------
specs = [
    {"depvar": "architect",             "label": "(1)", "bw_type": "CCT", "h": 14.94},
    {"depvar": "businessmanwoman",      "label": "(2)", "bw_type": "CCT", "h": 16.81},
    {"depvar": "engineer",              "label": "(3)", "bw_type": "CCT", "h": 18.67},
    {"depvar": "lawyer",                "label": "(4)", "bw_type": "CCT", "h": 13.83},
    {"depvar": "civil_administration",  "label": "(5)", "bw_type": "CCT", "h": 23.93},
    {"depvar": "teacher",               "label": "(6)", "bw_type": "CCT", "h": 12.39},
]
...
# 7. Save the table
# -----------------------------
with open("TableA14_PanelB.txt", "w", encoding="utf-8") as f:
    f.write(table_text)