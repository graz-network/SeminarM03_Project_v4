...
_LAUNCHER_SCRIPT_STEM = 'tableA14_PanelA'
_LAUNCHER_EXPECTED_PRIMARY_NAME = 'tableA14_PanelA.txt'
...
# -----------------------------
specs = [
    {"depvar": "age",                "label": "(1)", "bw_type": "CCT", "h": 21.75},
    {"depvar": "non_university_phd", "label": "(2)", "bw_type": "CCT", "h": 17.28},
    {"depvar": "university",         "label": "(3)", "bw_type": "CCT", "h": 23.02},
    {"depvar": "phd",                "label": "(4)", "bw_type": "CCT", "h": 16.69},
]
...
# 7. Save the table
# -----------------------------
with open("TableA14_PanelA.txt", "w", encoding="utf-8") as f:
    f.write(table_text)